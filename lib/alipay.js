...
var default_alipay_config = {
  ...
  ,alipay_wap_trade_create_direct_notify_url: '/alipay/alipay_wap_trade_create_direct_notify_url'
...
Alipay.prototype.route = function(app){
  ...
  app.post(this.alipay_config.alipay_wap_trade_create_direct_notify_url, function(req, res){self.alipay_wap_trade_create_direct_notify(req, res)});
